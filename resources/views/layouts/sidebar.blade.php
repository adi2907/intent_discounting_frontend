...
<div class="col-md-3 sidebar d-none d-md-block">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{route('show.identifiedUsers')}}" class="nav-link" @if($route == 'show.identifiedUsers') style="background-color: white; color:#1B4332;" @endif>
                <i class="fas fa-user ml-2"></i> Identified Users
            </a>
        </li>
        <li class="nav-item">
            <div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#"  @if($route == 'list.identified.user.segments') style="background-color: white; color:#1B4332;" @endif role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-th-list ml-1"></i> Segments
                </a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="{{ route('list.identified.user.segments') }}">
