        ...
        <div class="container mt-5">
            ...
            <div class="settings-card">
                ...
                <div class="settings-option">
                    ...
                    <input class="contact-input" type="text" placeholder="Become an Insider to our store. Exclusive updates await">
                </div>
                ...
                <div class="settings-option">
                    ...
                    <input class="contact-input" type="text" placeholder="Receive Whatsapp notifications on New Collections">
                </div>
                ...
                <div class="settings-option">
                    ...
                    <input class="discount-input" type="number" min="1" max="50" value="10">
                </div>
            ...
            <div class="settings-card">
                ...
                <div class="settings-option">
                    ...
                    <input class="validity-input" type="number" min="1" max="100" value="24">
                </div>
            </div>
        </div>  
    </section>
